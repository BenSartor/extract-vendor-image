...
echo "  fastboot flash radio ${DEST_DIR}/$(basename ${RADIO_IMG})"
echo "  fastboot flash bootloader ${DEST_DIR}/$(basename ${BOOTLOADER_IMG})"
echo "  fastboot flash vendor ${DEST_DIR}/$(basename ${VENDOR_IMG})"
